  ...
  <div class="home" v-else>
    ...
    <div class="wrapper-normal">
      ...
      <div class="lecturer-section">
        ...
        Rafał Jankowski
        <br>Po pierwsze: programista-pasjonat.
        <br>Człowiek od wszystkiego związanego z programowaniem.
      </div>
      <div class="questions">
        ...
        <ul>
          <li v-for="(question, index) in sortedQuestions">
            ...
            <div style="float: right">
              ...
              <font-awesome-icon icon="thumbs-up" size="lg" v-on:click="voteUp(question)"/>
              <br>
            </div>
          </li>
        </ul>
      ...
      <div class="rank-wrapper">
        ...
        <div class="rank">
          <font-awesome-icon icon="star" size="2x" class="checked"/>
          <br>
          <font-awesome-icon icon="star" size="2x" class="checked"/>
          <br>
          <font-awesome-icon icon="star" size="2x" class="checked"/>
...
import LectureNotes from "@/components/LectureNotes.vue";
